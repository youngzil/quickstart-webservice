...
@XmlRootElement(name = "add", namespace = "http://server.jws.webservice.quickstart.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "add", namespace = "http://server.jws.webservice.quickstart.org/", propOrder = {"a", "b"})
public class Add {
