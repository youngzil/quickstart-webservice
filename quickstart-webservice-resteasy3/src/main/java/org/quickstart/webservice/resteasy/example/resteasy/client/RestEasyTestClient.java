package org.quickstart.webservice.resteasy.example.resteasy.client;
...
import org.quickstart.webservice.resteasy.example.model.GenericResponse;
...
public class RestEasyTestClient {
	...
	public static void main(String[] args) {
		...
		//GET example
		ResteasyWebTarget getDummy = client.target("http://localhost:8080/quickstart-webservice-resteasy3/employee/99/getDummy");
        ...
        //POST example
		ResteasyWebTarget add = client.target("http://localhost:8080/quickstart-webservice-resteasy3/employee/add");
		...
		//DELETE example
		ResteasyWebTarget delete = client.target("http://localhost:8080/quickstart-webservice-resteasy3/employee/50/delete");
