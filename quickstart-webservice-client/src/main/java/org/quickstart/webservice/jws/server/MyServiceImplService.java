 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://server.jws.webservice.quickstart.org/", wsdlLocation = "http://localhost:8888/ns?wsdl")
public class MyServiceImplService extends Service {
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://server.jws.webservice.quickstart.org/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://server.jws.webservice.quickstart.org/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jws.webservice.quickstart.org/", "MyServiceImplPort"), IMyService.class, features);
    }
